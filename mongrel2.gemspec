# -*- encoding: utf-8 -*-
# stub: mongrel2 0.50.0.pre20170310132007 ruby lib

Gem::Specification.new do |s|
  s.name = "mongrel2".freeze
  s.version = "0.50.0.pre20170310132007"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sequel>.freeze, ["~> 4.2"])
      ...
      s.add_dependency(%q<sequel>.freeze, ["~> 4.2"])
